...
- **🛠️ Comprehensive API Coverage**: 149 tools spanning companies, contacts, tickets, projects, billing items, time entries, notes, attachments, and more
...
The server provides 149 tools for interacting with Autotask:
