...
- **🛠️ Comprehensive API Coverage**: 156 tools spanning companies, contacts, tickets, projects, billing items, time entries, notes, attachments, and more
...
The server provides 156 tools for interacting with Autotask:
