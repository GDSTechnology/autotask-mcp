...
- **🛠️ Comprehensive API Coverage**: 160 tools spanning companies, contacts, tickets, projects, billing items, time entries, notes, attachments, and more
...
The server provides 160 tools for interacting with Autotask:
