...
- **🛠️ Comprehensive API Coverage**: 163 tools spanning companies, contacts, tickets, projects, billing items, time entries, notes, attachments, and more
...
The server provides 163 tools for interacting with Autotask:
