...
- **🛠️ Comprehensive API Coverage**: 166 tools spanning companies, contacts, tickets, projects, billing items, time entries, notes, attachments, and more
...
The server provides 166 tools for interacting with Autotask:
